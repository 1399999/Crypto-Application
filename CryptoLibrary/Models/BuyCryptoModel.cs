...
{
    public class BuyCryptoModel : BaseCryptoModel
    {

        public BuyCryptoModel()
        {

        }
        public BuyCryptoModel(string name, string fee, string uSDBought, DateTime date, string exchangeRate)
        {
            Name = name;
